        ...
        <div className="flex-1 px-6 pt-12 pb-32">
          ...
          <div className="relative mb-6">
            ...
            <div className="bg-white rounded-[24px] pt-16 pb-6 -mt-[60px] shadow-sm">
              ...
              >
                {profile?.name || initialProfile?.name || userName || ru.profile.defaultName}
              </h2>
            </div>
          </div>
          ...
          <p className="text-center text-[#8E8E93] text-[14px] mt-6">
            {ru.profile.completedMeetings
              .replace("{completed}", completedMeetings.toString())
              .replace("{total}", totalMeetings.toString())}
          </p>
        </div>
      )}
