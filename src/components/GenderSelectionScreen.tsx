  ...
  return (
    <div className="flex min-h-screen flex-col" style={{ backgroundColor: "#E9E9E9" }}>
      ...
      <div className="flex-1 flex flex-col items-center px-6">
        <h2
          className="text-[32px] font-black leading-tight uppercase tracking-tight mb-12"
        ...
        <div className="flex flex-col gap-6 w-full max-w-[320px]">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center aspect-square rounded-[32px] transition-all duration-300"
            style={{
