          ...
          >
            ...
            <div className="bg-white rounded-t-[32px] -mt-4 px-6 py-8 flex-1 relative z-10">
              ...
              <button
                ...
                className={`w-full py-5 rounded-[20px] text-[17px] font-semibold transition-all ${
                  acceptedOffer ? "bg-[#E15859] text-white" : "bg-[#E15859]/40 text-white/60 cursor-not-allowed"
                }`}
              >
                Оплатить
              </button>
