...
const promotions: Promotion[] = [
  {
    id: 1,
    title: "Сертификат",
    shortText: "Не упустите уникальную возможность поучаствовать в нашей супер-акции. Только представьте себе: каждый участник получает шанс увеличить...",
    fullText: "Не упустите уникальную возможность поучаствовать в нашей супер-акции. Только представьте себе: каждый участник получает шанс увеличить вдвое! Для участия достаточно сделать минимальную ставку всего лишь в 10 рублей, а потенциальный выигрыш составит целых 100% от вложенной суммы!",
    price: "1500 Рублей",
  },
  {
    id: 2,
