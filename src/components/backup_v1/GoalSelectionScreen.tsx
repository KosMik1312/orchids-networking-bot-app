...
import { ChevronLeft, Plus, MessageCircle, Users } from "lucide-react";

export type GoalType = "experience" | "emotions" | "friends";
    ...
    <div className="flex h-screen flex-col overflow-x-hidden" style={{ backgroundColor: "#FFF7EF", touchAction: "pan-y" }}>
      ...
      <div className="flex-1 px-6 mb-4">
        <div className="flex flex-col gap-5 w-full max-w-[340px] mx-auto">
          {options.map((option) => {
            ...
            const isDimmed = selectedGoal !== null && !isSelected;
      ...
      <div className="flex items-center justify-between px-10 pb-12 gap-4 shrink-0">
        ...
        <button
          ...
          style={{
            backgroundColor: !selectedGoal ? "rgba(225, 88, 89, 0.3)" : "#E15859",
            color: "white",
            fontFamily: "'Montserrat', sans-serif",
          }}
        >
