    ...
    def create_payment(
        ...
        try:
            ...
            payment_params = {
                ...
                # 🎯 ВАЖНО: Явно указываем методы платежа для правильного интерфейса
                # Без этого Yookassa может открыть только Yomoney
                "payment_method_data": {
                    "type": "bank_card"  # Основной метод - банковская карта
                },
                "receipt": {
                    "customer": {
